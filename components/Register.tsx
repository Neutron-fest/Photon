...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white dark relative overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 md:px-12 py-4 border-b border-white/6 backdrop-blur-xl bg-black/60">
      ...
      <main className="relative z-10 min-h-screen pt-24 pb-20 px-4">
        <div className="max-w-2xl mx-auto">
          ...
          <form
            ...
            noValidate
            className="relative rounded-2xl border border-white/8 bg-white/2 backdrop-blur-xl overflow-hidden shadow-[0_32px_80px_rgba(0,0,0,0.7)]"
          >
            ...
            <div className="p-8 md:p-12 flex flex-col gap-8">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-6 pt-4 border-t border-white/6">

...
export default function CompetitionSlugPage() {
    ...
    return (
      <main className="h-screen w-full bg-[#F4F2EB] flex items-center justify-center text-[#2c2820] font-retro-serif">
        <div className="text-center">
          ...
          <Link
            href="/competitions"
            className="text-[#D84B4B] hover:text-[#4B7CD8] underline font-bold text-xl uppercase tracking-widest transition-colors"
          >
            ← Return to Base
          </Link>
        </div>
  ...
  return (
    <main className="relative w-full h-screen bg-[#F4F2EB] text-[#2c2820] font-retro-serif overflow-hidden overscroll-none selection:bg-[#E58B43] selection:text-white">
      <div
        className="fixed inset-0 pointer-events-none z-100 opacity-40 mix-blend-multiply"
        style={{
          backgroundImage:
      ...
      >
        <div className="w-[85vw] md:w-[70vw] lg:w-[60vw] shrink-0 flex flex-col justify-center h-full relative group">
          <div className="text-[0.9rem] sm:text-[1.1rem] md:text-[1.25rem] lg:text-[1.5rem] uppercase tracking-[0.32em] md:tracking-[0.4em] text-[#E58B43] mb-6 font-bold select-none">
            {comp.category}
          </div>
          <h1 className="text-[2.8rem] sm:text-[4rem] md:text-[5.5rem] lg:text-[7rem] leading-[0.95] font-medium tracking-tight relative cursor-pointer z-10 w-max pointer-events-auto">
            ...
            <span
              className="absolute left-0 top-0 text-[#D84B4B] -translate-x-1.5 translate-y-1.5 opacity-100 z-0 transition-none animate-shatter mix-blend-multiply pointer-events-none"
              aria-hidden="true"
            >
              {comp.title}
            </span>
            <span
              className="absolute left-0 top-0 text-[#4B7CD8] translate-x-1.5 -translate-y-1.5 opacity-100 z-0 transition-none animate-shatter mix-blend-multiply delay-75 pointer-events-none"
              aria-hidden="true"
          ...
          <p className="max-w-[80vw] md:max-w-3xl text-[1.1rem] sm:text-[1.35rem] md:text-[1.7rem] lg:text-[2rem] leading-[1.3] text-[#4d473d] mt-8 md:mt-10 pointer-events-none">
            {comp.subtitle}
          </p>
        </div>
        ...
        <div className="w-[85vw] md:w-[60vw] lg:w-[50vw] shrink-0 flex flex-col justify-center h-full relative cursor-auto pointer-events-auto">
          <div className="font-serif text-[4.5rem] sm:text-[6rem] md:text-[8rem] lg:text-[10rem] text-[#E58B43] leading-none -mb-12 sm:-mb-16 md:-mb-24 lg:-mb-32 opacity-30 select-none pointer-events-none">
            "
          </div>
        ...
        <div className="w-[85vw] md:w-[60vw] lg:w-[55vw] shrink-0 flex flex-col justify-center h-full cursor-auto pointer-events-auto">
          <h2 className="text-[1.8rem] sm:text-[2.4rem] md:text-[3.2rem] lg:text-[4.2rem] font-bold mb-10 md:mb-16 border-b-[6px] border-[#2c2820] pb-4 md:pb-6 inline-block uppercase self-start leading-none pointer-events-none text-[#2c2820]">
            Mission Intel
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-20 gap-y-16">
            <div className="border-l-[6px] border-[#D84B4B] pl-6 md:pl-8 pointer-events-none">
              <div className="uppercase tracking-widest text-[#D84B4B] text-[0.8rem] sm:text-[0.95rem] md:text-[1.05rem] font-bold mb-3 md:mb-4">
                Bounty Pool
              </div>
              <div className="text-[1.7rem] sm:text-[2.2rem] md:text-[2.8rem] lg:text-[3.4rem] font-medium leading-none text-[#2c2820]">
                {comp.prizePool}
              </div>
            </div>
            <div className="border-l-[6px] border-[#4B7CD8] pl-6 md:pl-8 pointer-events-none">
              <div className="uppercase tracking-widest text-[#4B7CD8] text-[0.8rem] sm:text-[0.95rem] md:text-[1.05rem] font-bold mb-3 md:mb-4">
                Sector
              </div>
              <div className="text-[1.7rem] sm:text-[2.2rem] md:text-[2.8rem] lg:text-[3.4rem] font-medium leading-none text-[#2c2820]">
                {comp.location}
            ...
            <div className="border-l-[6px] border-[#5C9E6D] pl-6 md:pl-8 pointer-events-none">
              <div className="uppercase tracking-widest text-[#5C9E6D] text-[0.8rem] sm:text-[0.95rem] md:text-[1.05rem] font-bold mb-3 md:mb-4">
                Crew Size
              </div>
              <div className="text-[1.7rem] sm:text-[2.2rem] md:text-[2.8rem] lg:text-[3.4rem] font-medium leading-none text-[#2c2820]">
                {comp.teamSize}
            ...
            <div className="border-l-[6px] border-[#E2C151] pl-6 md:pl-8 pointer-events-none">
              <div className="uppercase tracking-widest text-[#E2C151] text-[0.8rem] sm:text-[0.95rem] md:text-[1.05rem] font-bold mb-3 md:mb-4">
                Deploy Date
              </div>
              <div className="text-[1.7rem] sm:text-[2.2rem] md:text-[2.8rem] lg:text-[3.4rem] font-medium leading-none text-[#2c2820]">
                {comp.date}
        ...
        <div className="w-[90vw] md:w-[75vw] lg:w-[65vw] shrink-0 flex flex-col justify-center h-full mr-12 md:mr-24 pointer-events-auto cursor-auto">
          ...
          >
            <h3 className="text-[1.5rem] sm:text-[1.8rem] md:text-[2.3rem] lg:text-[2.8rem] font-bold uppercase mb-6 text-[#2c2820] pointer-events-none">
              Protocol Rules
            </h3>
            <ul className="list-disc pl-8 md:pl-10 space-y-3 text-[0.95rem] sm:text-[1.05rem] md:text-[1.2rem] lg:text-[1.4rem] leading-snug mb-8 md:mb-10 whitespace-normal text-[#4d473d] font-medium">
              {comp.rules.slice(0, 3).map((rule: any, i: number) => (
                <li key={i} className="pl-2 pointer-events-none">
                  ...
                  {rule.content.length > 70
                    ? rule.content.slice(0, 70) + "..."
                    : rule.content}
                </li>
              ))}
            </ul>
            ...
            <div className="flex flex-col items-center group relative cursor-pointer pt-8 border-t-2 border-[#2c2820] border-dashed">
              ...
              <span
                className="absolute text-[#D84B4B] -translate-x-2 translate-y-2 opacity-0 group-hover:opacity-100 z-0 transition-none animate-shatter mix-blend-multiply pointer-events-none text-center text-[1.8rem] sm:text-[2.3rem] md:text-[3rem] lg:text-[3.8rem] font-black uppercase leading-none"
                aria-hidden="true"
              >
                Ready to Execute?
              </span>
